...
const PropertyList = () => {
    return (
        <div className="pList">
            ...
            <div className="pListItem">
                <img className="pListImg" src="https://cf.bstatic.com/static/img/theme-index/carousel_320x240/bg_cottages/5e1fd9cd716f4825c6c7eac5abe692c52cc64516.jpg" alt="" />
                <div className="pListTitles">
                    <h1>Cottages</h1>
                    <h2>643 cottages</h2>
                </div>
